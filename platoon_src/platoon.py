...
class Platoon():
    ...
    def __init__(self, startingVehicles):
        ...
        """ ccyen """
        self._eligibleForSplitting = False
    ...
    def canSplit(self):
        """
        Returns True if this platoon needs to be split up into two
        """
        return self._eligibleForSplitting
    ...
    def setSplit(self, split):
        self._eligibleForSplitting = split
