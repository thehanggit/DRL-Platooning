...
class SumoEnvironment(MultiAgentEnv):
    ...
    def __init__(self, net_file, route_file, phases, out_csv_name=None, use_gui=False, num_seconds=20000, max_depart_delay=100000,
                 time_to_load_vehicles=0, num_veh_plat=5, gap_between_vehicles=1, delta_time=5, min_green=5, max_green=50, single_agent=True):
        ...
        self.num_veh_plat = num_veh_plat
        self.gap_between_vehicles = gap_between_vehicles
        
        self.max_num_veh_plat = 20
        self.max_gap_between_vehicles = 2
        
        self.manager = SimulationManager(self.num_veh_plat, self.gap_between_vehicles, True, False)
        ...
        self.action_space = spaces.Discrete(self.max_num_veh_plat)
    ...
    def _apply_actions(self, actions):
        ...
        """   
        self.manager.setMaxNumOfVehInAPlat(actions)
    ...
    def _compute_rewards(self):
        return self._fuel_consumption_reward()
