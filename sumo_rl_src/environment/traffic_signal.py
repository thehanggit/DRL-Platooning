...
class TrafficSignal:
    ...
    def __init__(self, env, ts_id, delta_time, min_green, max_green, phases, num_green_phases):
        self.id = ts_id
        self.env = env
        ...
        self.green_phase = 0
        self.num_green_phases = num_green_phases#len(phases) // 2
    ...
    def get_fuel_consumption(self):
        return [sum([traci.lane.getFuelConsumption(lane) for lane in self.edges[p]]) for p in range(self.num_green_phases)]
